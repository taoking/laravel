...
class QueryLogResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'logical_plan_hash' => $this->logical_plan_hash,
            'permission_hash' => $this->permission_hash,
            'permission_applied' => $this->permission_applied,
            ...
            'semantic_layer_used' => $this->semantic_layer_used,
            'semantic_metrics_json' => $this->semantic_metrics_json,
            'semantic_dimensions_json' => $this->semantic_dimensions_json,
            'metric_versions_json' => $this->metric_versions_json,
            ...
            'raw_duration_ms' => $this->raw_duration_ms,
