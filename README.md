...
Laravel BI Platform 是一个基于 Laravel 13 和 Vue 3 的轻量 BI 管理平台，覆盖数据源接入、数据集建模、语义层指标库、元数据治理、动态查询、图表配置、仪表盘、导入导出、缓存、数据权限、审计日志、监控指标和管理端页面。
...
- Vue 管理端：登录、主布局、菜单路由、数据源、数据集、语义层、数据治理、图表、仪表盘、导入导出、查询日志、权限管理、系统监控。
...
- [BI 元数据目录 / 数据血缘 / 影响分析](docs/bi-metadata-lineage.md)：Phase 12 的元数据资产、血缘关系、影响分析、标签、使用统计、权限和边界。
